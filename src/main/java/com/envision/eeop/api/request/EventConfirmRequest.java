...
import com.envision.eeop.api.response.EventConfirmResponse;
import com.envision.eeop.api.util.EnvisionHashMap;

import java.util.Map;


public class EventConfirmRequest implements EnvisionRequest<EventConfirmResponse> {
    ...
    public EventConfirmRequest(String eventId, String confirmPerson, String confirmValue) {
    ...
    @Override
    public Class<EventConfirmResponse> getResponseClass() {
        return EventConfirmResponse.class;
    }
