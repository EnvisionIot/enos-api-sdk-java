import com.envisioniot.enos.enosapi.api.request.connectservice.GetMeasurepointsDataByAssetIDRequest;
 ...
 */
public class GetMeasurepointsDataByAssetIDRequestTest
{
    public static void main(String[] args) throws EnOSApiException
    {
        ...
        String assetId = "51Dilemr";
        GetMeasurepointsDataByAssetIDRequest request = new GetMeasurepointsDataByAssetIDRequest(orgId, assetId);
