 ...
 *
 */
public class MdmDomainPointsGetRequestTest {
	...
	public void testWithFields() throws EnvisionApiException {
		...
		MdmDomainPointsGetRequest request = new MdmDomainPointsGetRequest(
				deviceIDList, pointIDList, fieldList);

		MdmDomainPointsGetResponse response = client.execute(request);
