...
public class MdmIDsByValueGetRequestTest
{
    ...
    private static EnvisionClient client = new EnvisionDefaultClient("http://localhost:8080/eeop", "a0720bb5-916c-43e2-b8e4-b129cfaf8bb6", "0E133FBBFC57CA282FC2FC34C6651218");

    @Test
    public void getGet() throws EnvisionApiException
    {
        MdmIDsByValueGetRequest request = new MdmIDsByValueGetRequest("9184ddb253464235948ac0c521e964a4", 207, "CBX.State", "1");
