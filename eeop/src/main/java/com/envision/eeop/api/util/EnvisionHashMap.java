...
/**
 * Envision Hash Map Define
 */
public class EnvisionHashMap extends HashMap<String, String> {

	private static final long serialVersionUID = -1277791390393392630L;

	public EnvisionHashMap() {
		super();
	}

	public EnvisionHashMap(Map<? extends String, ? extends String> m) {
		super(m);
	}
